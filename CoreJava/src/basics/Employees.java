...
public class Employees {
	...
	public void setEmpData(String empName,int empid,double empsal,String empDesignation) {
	...
	public static void main(String[] args) {
		...
		Employees Divya=new Employees();
		Divya.setEmpData("Divya",1521,10000,"Software Tester");
		Divya.printEmpData();
		...
		Employees Sai=new Employees();
		Sai.setEmpData("Sai",1522,15000,"Software Developer");
		Sai.printEmpData();
		
		System.out.println("************************************************");
		System.out.println("************************************************");
		
		Employees Dan=new Employees();
		Dan.setEmpData("Dan",1523,20000,"BA");
		Dan.printEmpData();
		
		System.out.println("************************************************");
		System.out.println("************************************************");
		
		Employees Devi=new Employees();
		Devi.setEmpData("Devi",1524,25000,"Data Scientist");
		Devi.printEmpData();
		...
		Employees JJJ=new Employees();
		JJJ.setEmpData("JJJ",1525,30000,"Software Tester");
		JJJ.printEmpData();
